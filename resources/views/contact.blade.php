    ...
    <section class="ftco-section contact-section">
      <div class="container">
        ...
        <div class="row block-9 justify-content-center mb-5">
          ...
          @endif
            <form method="POST" action="{{url('contact/sendemail')}}" class="bg-light p-5 contact-form">
                {{ csrf_field()}}
            <div class="form-group">
              ...
              <div class="form-group">
                <textarea id="" cols="30" rows="7" name="message" class="form-control" placeholder="Message" value="{{old('message')}}"></textarea>
              </div>
              <div class="form-group">
